...
public class UserSrvList {
    ...
    @RequestMapping(value = "/{serverType}/getUserServiceList", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
    public ResponseEntity<UserServiceListModel[]> getUserServiceList(
        ...
        return userSrvService.getAllUserSrvList(serverType, access_token, requestBody);
    }
}
